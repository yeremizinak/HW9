...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("\nARRAYLIST");
        System.out.println("Current size of an array is " + arrayList.size() + ". Got a random element of an array: " + arrayList.get(random.nextInt(countElements)));
        ...
        System.out.println("\nLINKEDLIST");
        System.out.println("Current size of an array is " + linkedList.size() + ". Got a random element of an array: " + linkedList.get(random.nextInt(countElements)));
        ...
        System.out.println("\nSTACK");
        System.out.println("Current size of an array is " + stack.size() + ". First element and deleted: " + stack.pop() + ". Removed a random element of an array and got a new size: ");
        ...
        System.out.print("Removed a random pair by " + keyTwo + " key and got a new size of the collection: " + hashMap.size());
